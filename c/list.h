...
static inline size_t list_count_entries(struct list_head *head)
{
 ...
 */
static inline struct list_head *merge(int (*cmp)(struct list_head *a,
						 struct list_head *b,
						 void *data),
				      void *data,
				      struct list_head *a,
 ...
 * throughout.
 */
static inline void merge_and_restore_back_links(int (*cmp)(struct list_head *a,
							   struct list_head *b,
							   void *data),
						void *data,
						struct list_head *head,
